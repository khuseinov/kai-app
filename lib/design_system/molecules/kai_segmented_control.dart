...
/// Segmented pill control. Canon: `new-design/settings.html § .seg`.
///
/// ```
/// container: surface-3 bg, radius 8, padding 2, gap 2 between options
/// option: padding 4 x 9, font 500/11 sans, color ink-3, radius 6
