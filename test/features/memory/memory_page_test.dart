...
void main() {
  ...
  group('MemoryPage Widget Tests', () {
    testWidgets('renders all canonical mockup sections and details', (tester) async {
      ...
      await tester.pumpWidget(pumpMemoryPage(repository: mockRepo));
      await tester.pumpAndSettle();

      final l10n = AppLocalizations.of(tester.element(find.byType(MemoryPage)));
